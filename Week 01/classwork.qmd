...
This document was created using [Quarto](https://quarto.org/docs/get-started/hello/rstudio.html) a sort of language for combining code and text. When you're following along in class, you can either copy-paste code directly from this page into an R-studio script file, or you can go over to the github site for this class, [download the .qmd file for this classwork](https://github.com/Neilblund/GVPT628_Fall2026/blob/main/Week%2001/classwork.qmd) and then open it in R-studio and work with it as an interactive document. 
